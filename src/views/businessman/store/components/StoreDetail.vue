...
import { getStoreGoods } from '@/api/store'
...
const getStoreDetailAndGoods = async () => {
  const res = await getStoreGoods(route.params.id)
  store.value = res.data
}

onMounted(() => {
  getStoreDetailAndGoods()
})
</script>
        ...
        <el-main>
            <div class="goods-wrapper">
                <div class="goods-list">
                    <div class="goods-item" v-for="(item) in store.goodsList" :key="item.id"
