...
<template>
  <pageContainer title="订单管理" @click="handleClickOutside">
    ...
    <el-table v-if="withdrawRecordList.length !== 0" :data="withdrawRecordList" style="width: 100%" v-loading="loading"
     ...
     <!--  <el-table-column prop="username" label="买家账号" width="120" align="center" /> -->
      ...
      <el-table-column prop="originMoney" label="原先的钱" align="center">
        <template #default="{row}">
      ...
      <el-table-column label="现在的钱" align="center">
        <template #default="{row}">
